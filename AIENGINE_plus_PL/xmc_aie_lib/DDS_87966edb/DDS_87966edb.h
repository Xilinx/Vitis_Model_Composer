#ifndef _DDS_87966EDB_GRAPH_H_
#define _DDS_87966EDB_GRAPH_H_

#include <adf.h>
#include "dds_mixer_graph.hpp"


class DDS_87966edb : public adf::graph
{
public:
	adf::port<output> out;

	const uint32_t phaseIncr = 33554432;
	...
	DDS_87966edb() : sg(phaseIncr, initPhaseOffset)
	{
...
#endif //ifndef _DDS_87966EDB_GRAPH_H_
