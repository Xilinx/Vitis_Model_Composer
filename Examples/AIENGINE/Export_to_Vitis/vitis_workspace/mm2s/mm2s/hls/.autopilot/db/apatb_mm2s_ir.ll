; ModuleID = '/proj/xcoswmktg/robg/git/Vitis-Tutorials/Internal-Fork/AI_Engine_Development/Feature_Tutorials/05-AI-engine-versal-integration/workAIE/mm2s/mm2s/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_mm2s_ir(%"struct.ap_int<32>"* noalias nocapture nonnull readonly "maxi" %mem, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %s, i32 %size) local_unnamed_addr #0 {
entry:
...
entry:
  ...
  call void @mm2s_hw_stub(%"struct.ap_int<32>"* %6, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* %7, i32 %5)
  call void @copy_in(%"struct.ap_int<32>"* %6, i32* %0, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* %7, i32* %1, i4* %2, i4* %3, i1* %4)
  ret void
}

declare void @mm2s_hw_stub(%"struct.ap_int<32>"*, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"*, i32)
