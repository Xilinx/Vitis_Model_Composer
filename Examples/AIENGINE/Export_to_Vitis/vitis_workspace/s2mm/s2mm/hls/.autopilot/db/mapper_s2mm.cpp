...
static AESL_RUNTIME_BC __xlx_s_V_data_V_V_size_Reader("../tv/stream_size/stream_size_in_s_V_data_V.dat");
unsigned int ap_apatb_s_V_keep_V_cap_bc;
static AESL_RUNTIME_BC __xlx_s_V_keep_V_V_size_Reader("../tv/stream_size/stream_size_in_s_V_keep_V.dat");
unsigned int ap_apatb_s_V_strb_V_cap_bc;
static AESL_RUNTIME_BC __xlx_s_V_strb_V_V_size_Reader("../tv/stream_size/stream_size_in_s_V_strb_V.dat");
unsigned int ap_apatb_s_V_last_V_cap_bc;
static AESL_RUNTIME_BC __xlx_s_V_last_V_V_size_Reader("../tv/stream_size/stream_size_in_s_V_last_V.dat");
using hls::sim::Byte;
extern "C" void s2mm(Byte<4>*, int, volatile void *, volatile void *, volatile void *, volatile void *, int);
extern "C" void apatb_s2mm_hw(volatile void * __xlx_apatb_param_mem, volatile void * __xlx_apatb_param_s_V_data_V, volatile void * __xlx_apatb_param_s_V_keep_V, volatile void * __xlx_apatb_param_s_V_strb_V, volatile void * __xlx_apatb_param_s_V_last_V, int __xlx_apatb_param_size) {
...
auto* ss_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_s_V_last_V);
  // DUT call
  s2mm(__xlx_mem__tmp_vec.data(), __xlx_offset_byte_param_mem, ss_V_data_V->data<int>(), ss_V_keep_V->data<char>(), ss_V_strb_V->data<char>(), ss_V_last_V->data<char>(), __xlx_apatb_param_size);
