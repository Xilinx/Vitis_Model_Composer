...
## Examples
- [Using the AI Engine FIR block](fir/README.md)
- [Using the AI Engine FIR Stream block](fir_ssr/README.md)
- [Using the AI Engine FFT block](fft/README.md)
- [Using the AI Engine FFT Stream block](stream_fft/README.md)
