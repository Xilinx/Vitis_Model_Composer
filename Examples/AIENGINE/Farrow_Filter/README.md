...
More details on the Farrow filter design for AI Engines can be found in the [Vitis-Tutorials](https://github.com/Xilinx/Vitis-Tutorials/tree/2026.1/AI_Engine_Development/AIE/Design_Tutorials/15-farrow_filter) repository.
