...
2. The build process will take some time. When complete, the outputs will appear in a new folder named `package`. An sd_card.img file, generated by Vitis, for testing this design on the board.
...
* VCK190 Evaluation board
  ...
  * For board setup and establish a connection to a serial device by selecting “Serial”,please refer to (https://github.com/Xilinx/Vitis_Model_Composer/tree/2024.2/QuickGuides/Running_on_Hardware/linux).
