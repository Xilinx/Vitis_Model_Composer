...
int main(int argc, char* argv[])
{
  ...
  std::cout << STR_PASSED << "auto dma_src = xrt::kernel(my_device, xclbin_uuid, \"ifft_dma_src_wrapper:{dma_src}\")" << std::endl;

  auto dma_snk = xrt::kernel(my_device, xclbin_uuid, "ifft_dma_snk_wrapper:{dma_snk}");
  std::cout << STR_PASSED << "auto dma_snk = xrt::kernel(my_device, xclbin_uuid, \"ifft_dma_snk_wrapper:{dma_snk}\")" << std::endl;
