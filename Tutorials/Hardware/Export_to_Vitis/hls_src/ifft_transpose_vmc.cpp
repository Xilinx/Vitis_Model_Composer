...
void ifft_unpack( TT_STREAM& sig_0_i, 
                  TT_STREAM& sig_1_i,
                  TT_STREAM& sig_2_i, 
                  TT_STREAM& sig_3_i, 
                  TT_STREAM& sig_4_i, 
...
{
    ( trans_i[1], trans_i[0] ) = sig_0_i.read();
    ( trans_i[3], trans_i[2] ) = sig_1_i.read();
    ( trans_i[5], trans_i[4] ) = sig_2_i.read();
    ( trans_i[7], trans_i[6] ) = sig_3_i.read();
    ( trans_i[9], trans_i[8] ) = sig_4_i.read();
...
void ifft_write_streams( TT_SAMPLE (&trans_o)[2*NSTREAM], 
                         TT_STREAM& sig_0_o,
                         TT_STREAM& sig_1_o,
                         TT_STREAM& sig_2_o,
                         TT_STREAM& sig_3_o,
...
#pragma HLS reset variable=startup
  ...
  if ( running == 1) {
    sig_0_o.write( (trans_o[1], trans_o[0]) );
    sig_1_o.write( (trans_o[3], trans_o[2]) );
    sig_2_o.write( (trans_o[5], trans_o[4]) );
    sig_3_o.write( (trans_o[7], trans_o[6]) );
    sig_4_o.write( (trans_o[9], trans_o[8]) );
  }
...
void ifft_transpose_wrapper( ifft_transpose::TT_STREAM& sig_0_i, 
                             ifft_transpose::TT_STREAM& sig_1_i,
                             ifft_transpose::TT_STREAM& sig_2_i,
                             ifft_transpose::TT_STREAM& sig_3_i,
                             ifft_transpose::TT_STREAM& sig_4_i,
                             ifft_transpose::TT_STREAM& sig_0_o,
                             ifft_transpose::TT_STREAM& sig_1_o,
                             ifft_transpose::TT_STREAM& sig_2_o,
                             ifft_transpose::TT_STREAM& sig_3_o,
                             ifft_transpose::TT_STREAM& sig_4_o )
{
...
#pragma HLS array_partition variable=transpose_o dim=1
  ...
  // Unpack samples:
  ifft_unpack( sig_0_i, sig_1_i, sig_2_i, sig_3_i, sig_4_i, transpose_i );

  // Transpose samples:
  ifft_do_transpose( transpose_i, transpose_o );

  // Format output streams:
  ifft_write_streams( transpose_o, sig_0_o, sig_1_o, sig_2_o, sig_3_o, sig_4_o );
}
